...
class TestUpdateProfile:
    ...
    def test_update_name_in_the_profile(self, api_manager: ApiManager, user_request: CreateUserRequest, update_profile_request: UpdateProfileRequest):
        ...
        customer_dao = api_manager.database_steps.get_customer_by_customer_id(profile.customer.id)
        DaoAndModelAssertions.assert_that(profile.customer, customer_dao).match()
